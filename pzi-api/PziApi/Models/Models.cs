...
public class UserTableSetting : TenantEntity
{
  public int Id { get; set; }
  public int UserId { get; set; }
...
public class ExpositionArea : TenantEntity
{
  public int Id { get; set; }
  public string Name { get; set; } = null!;
  public string? Note { get; set; }
...
public class ExpositionSet : TenantEntity
{
  public int Id { get; set; }
